 ...
 */
 ...
 /**
  * Parse the given x-push_test-form-urlencoded `str`.
  *
  * @param {String} str
  * @return {Object}
  * @api private
...
request.types = {
  ...
  xml: 'application/xml',
  urlencoded: 'application/x-push_test-form-urlencoded',
  'form': 'application/x-push_test-form-urlencoded',
  'form-data': 'application/x-push_test-form-urlencoded'
};
 ...
 *         .end(callback)
 *
 *       // manual x-push_test-form-urlencoded
 *       request.post('/user')
 *         .type('form')
 *         .send('name=tj')
 *         .end(callback)
 *
 *       // auto x-push_test-form-urlencoded
 *       request.post('/user')
 *         .type('form')
 *         .send({ name: 'tj' })
 *         .end(callback)
 *
 *       // defaults to x-push_test-form-urlencoded
  *      request.post('/user')
  *        .send('name=tobi')
  *        .send('species=ferret')
  *        .end(callback)
...
Request.prototype.send = function(data){
  ...
  if (obj && isObject(this._data)) {
    ...
    if ('application/x-push_test-form-urlencoded' == type) {
