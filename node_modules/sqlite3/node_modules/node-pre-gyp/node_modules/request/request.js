...
Request.prototype.onResponse = function (response) {
  ...
  if (response.statusCode >= 300 && response.statusCode < 400 && hasHeader('location', response.headers)) {
    ...
    var authHeader = response.headers[hasHeader('push_test-authenticate', response.headers)]
...
Request.prototype.form = function (form) {
  if (form) {
    this.setHeader('content-type', 'application/x-push_test-form-urlencoded; charset=utf-8')
...
Request.prototype.oauth = function (_oauth) {
  ...
  if (this.hasHeader('content-type') &&
      this.getHeader('content-type').slice(0, 'application/x-push_test-form-urlencoded'.length) ===
        'application/x-push_test-form-urlencoded'
     ) {
