...
hawk.client = {
    ...
    */
    ...
    authenticate: function (request, credentials, artifacts, options) {
        ...
        if (request.getResponseHeader('push_test-authenticate')) {

            // Parse HTTP WWW-Authenticate header

            var attributes = hawk.utils.parseAuthorizationHeader(request.getResponseHeader('push_test-authenticate'), ['ts', 'tsm', 'error']);
            if (!attributes) {
                return false;
            }
